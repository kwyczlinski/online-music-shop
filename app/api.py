...
#     @app.patch("/api/order/<int:order_id>/cancel")
#     def cancel_order():
#         return jsonify({}), 200

#     @app.patch("/api/order/<int:order_id>/advance")
#     def advance_order():
#         return jsonify({}), 200

#     @app.patch("/api/order/<int:order_id>/return")
#     def return_order():
#         return jsonify({}), 200

#     @app.patch("/api/order/<int:order_id>r/email")
#     def update_email():
#         # json {"email": ...}
#         return jsonify({}), 200

#     @app.patch("/api/order/<int:order_id>/address")
#     def update_address():
#         # json {"housenumber": "...", "street": "...", etc}
#         return jsonify({}), 200
    
#     @app.get("api/orders/email/<path:email")
#     def get_email_orders():
#         return jsonify([]), 200
